namespace System
{
    ...
    /// <summary>
    /// http://www.elanant.com/2009/06/base32encoding-implementation-for-net.html
    /// </summary>
    class Base32Encoder
    {
    ...
    /// http://www.elanant.com/2009/06/base32encoding-implementation-for-net.html
    /// </summary>
    class ZBase32Encoder : Base32Encoder
    {
    ...
    static class ZBase32Extensions
    {
        private static readonly ZBase32Encoder zBase32 = new ZBase32Encoder();
        ...
        public static byte[] FromZBase32String(this string value)
        {
            if (string.IsNullOrEmpty(value)) return null;

            return zBase32.Decode(value);
        }
    }
}
