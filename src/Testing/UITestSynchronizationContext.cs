namespace System.Threading
{
    ...
    [DebuggerStepThrough]
    class UITestSynchronizationContext : SynchronizationContext, IDisposable
    {
        struct WorkItem
        {
        ...
        public static UITestSynchronizationContext BindToCurrent()
        {
            var result = new UITestSynchronizationContext();
        ...
        public UITestSynchronizationContext()
        {
